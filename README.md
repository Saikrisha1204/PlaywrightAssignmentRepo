...
Create a feature branch: git checkout -b feature/short-name
Add your test in tests/ as feature.spec.js, following the existing patterns — constants at top, role-based locators, multi-angle assertions.
Run the full suite locally: npx playwright test
Open a pull request describing the change and what it verifies.
